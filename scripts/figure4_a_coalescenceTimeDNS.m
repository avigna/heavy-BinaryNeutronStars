function figure4_a_coalescenceTimeDNS(dir,plotFlag,saveFlag,debugFlag)
%
...
%     color5 = [    0.4660    0.6740    0.1880];
    ...
    hLabel=text(0.2,5.5,numTop,'$\rm{\bf{a}}$','FontSize',fs,'Color','w','Interpreter','Latex');
    ...
    if saveFlag
        print(gcf,'./Plots/figure4_coalescenceTimeDNS.pdf','-dpdf');
    end
end
